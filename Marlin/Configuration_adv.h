...
#define CHAMBER_AUTO_FAN_PIN    FAN5_PIN
...
// @section lcd
  ...
  #define MANUAL_FEEDRATE { 200*60, 200*60, 40*60, 4*60 } // (mm/min) Feedrates for manual moves along X, Y, Z, E from panel
