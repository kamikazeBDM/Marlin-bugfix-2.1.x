...
//
  ...
  #define HEATER_CHAMBER_PIN E1_DIAG_PIN        // Required heater on/off pin (example: SKR 1.4 Turbo HE1 plug)
  ...
  #define CHAMBER_FAN               // Enable a fan on the chamber
    ...
    #define CHAMBER_FAN_MODE 1        // Fan control mode: 0=Static; 1=Linear increase when temp is higher than target; 2=V-shaped curve; 3=similar to 1 but fan is always on.
      ...
      #define CHAMBER_FAN_BASE 10    // Chamber fan PWM (0-255)
    #elif CHAMBER_FAN_MODE == 1
      #define CHAMBER_FAN_BASE 10    // Base chamber fan PWM (0-255); turns on when chamber temperature is above the target
      ...
      #define CHAMBER_FAN_BASE 10    // Base chamber fan PWM (0-255)
      #define CHAMBER_FAN_FACTOR 5   // PWM increase per °C above target
    #endif
  #endif
 ...
 */
  ...
  #define THERMAL_PROTECTION_BED_HYSTERESIS 10     // (°C)
 ...
 */
  ...
  #define THERMAL_PROTECTION_CHAMBER_PERIOD 360    // (seconds)
...
#define FAST_PWM_FAN    // Increase the fan PWM frequency. Removes the PWM noise but increases heating in the FET/Arduino
  ...
  #define FAST_PWM_FAN_FREQUENCY 1000U  // Define here to override the defaults below
...
#define EXTRUDER_AUTO_FAN_SPEED 255   // 255 == full 

#define CHAMBER_AUTO_FAN_TEMPERATURE 70
...
#define CASE_LIGHT_ENABLE
  ...
  #define CASE_LIGHT_PIN          FAN4_PIN    // Override the default pin if needed
...
#define INPUT_SHAPING_Z
    ...
    #define SHAPING_ZETA_Y 0.30         // Damping ratio of the Y axis (range: 0.0 = no damping to 1.0 = critical damping).
  #endif
  #if ENABLED(INPUT_SHAPING_Z)
    #define SHAPING_FREQ_Z  40.0        // (Hz) The default dominant resonant frequency on the Z axis.
    #define SHAPING_ZETA_Z   0.30       // Damping ratio of the Z axis (range: 0.0 = no damping to 1.0 = critical damping).
  #endif
 ...
 */
#define DEFAULT_STEPPER_TIMEOUT_SEC 480
...
#define DEFAULT_MINIMUMFEEDRATE 3.0           // (mm/s) Minimum feedrate. Set with M205 S.
...
// @section lcd
  ...
  #define MANUAL_FEEDRATE { 200*60, 200*60, 50*60, 4*60 } // (mm/min) Feedrates for manual moves along X, Y, Z, E from panel
 ...
 */
  ...
  #define LCD_TIMEOUT_TO_STATUS 1200000   // (ms)
...
// Control heater 0 and heater 1 in parallel. ( "EXTRUDERS must be 1 with HEATERS_PARALLEL.")
 ...
 */
#define RX_BUFFER_SIZE 2048   // 2^2 must be power of 2 > MAX_CMD_SIZE (96) * BUFSIZE (16)
